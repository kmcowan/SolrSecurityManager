...
public class EditUserDialog extends BaseDialog {
     ...
     * @param modal
     */
    public EditUserDialog(Frameable parent, boolean modal, String userName) {
        super(parent.getFrame(), modal);
        initComponents();
        this.frame = parent;
        this.selectedUser = userName;
        this.userNameField.setText(this.selectedUser);
        super.center();
    }
    ...
    private boolean passwordsMatch() {
        ...
        if (!p1.equals(p2)) {
            ...
            Log.log(getClass(), "Pwds are empty...");
            this.showMessageDialog("Passwords cannot be empty!  SHA-256 is a ONE-WAY algorithm.  Editing the user requires changing the password. ");
            return false;
        }
        return true;
    }
    ...
    private void doAddUserAction(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_doAddUserAction
        ...
        try {
            if (!selectedUser.equals(this.userNameField.getText())) {
                  String delresult = SolrAuthActionController.deleteUser(selectedUser);
                  Log.log(getClass(), "Delete user ["+selectedUser+"] "+delresult);
                frame.showOKOnlyMessageDialog("You have changed the name of this user.  Roles assigned to the old user name will need to be updated. ", Resources.Resource.warn);
            }
            ...
            if (allowedChars && pwdMatch) {
                ...
                if (result != null && !result.trim().equals("")) {
                    ...
                    results.put("old_user", selectedUser);
                    this.frame.fireAction(SolrManagerAction.edit_user, results, null);
                }
            } else {
                String message = "";
                if (!allowedChars) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EditUserDialog dialog = new EditUserDialog(new SolrAuthMainWindow(), true, "");
